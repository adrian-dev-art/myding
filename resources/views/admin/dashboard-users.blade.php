            ...
            <tbody>
              ...
              <tr class="bg-gray-800">
                ...
                <td class="p-3 inline-flex">
                  <a href="{{ route('user.show', ['user' => $user->id]) }}" class="text-gray-400 hover:text-gray-100  mx-2">
                  ...
                  <a href="{{ route('user.edit', ['user' => $user->id]) }}" class="text-gray-400 hover:text-gray-100 mr-2">
                    <i class="material-icons-outlined text-base">
                  ...
                  <form action="{{ route('user.destroy', ['user' => $user->id]) }}" method="POST">
                    @method('delete')
                    @csrf
                    <button href="btn btn-outline-danger" class="text-gray-400 hover:text-gray-100  ml-2" type="submit" onclick="return confirm('are you sure?')" >
