          ...
          <table class="table text-gray-400 border-separate space-y-6 text-sm">
            ...
            <tbody>
              ...
              <tr class="bg-gray-800">
                ...
                <a href="{{ route('category.show', ['category' => $category->id]) }}" class="text-gray-400 hover:text-gray-100  mx-2">
                  ...
                  <a href="{{ route('category.edit', ['category' => $category->id]) }}" class="text-gray-400 hover:text-gray-100 mr-2">
                    <i class="material-icons-outlined text-base">
                  ...
                  <a href="{{ route('category.destroy', ['category' => $category->id]) }}" class="text-gray-400 hover:text-gray-100  ml-2">
